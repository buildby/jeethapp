...
class VehicleModelWidget extends StatefulWidget {
  ...
  const VehicleModelWidget(this.updateSelectedCount, this.selectedVehicleModel,
      this.storedSelectedCount, this.selectedMake,
      {super.key});
...
class VehicleModelWidgetState extends State<VehicleModelWidget> {
  ...
  void initState() {
    super.initState();
    models = Provider.of<AuthProvider>(context, listen: false)
        .models
        .where((element) => element['make'] == widget.selectedMake)
        .toList();
